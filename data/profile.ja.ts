...
export const profileJa: ProfileData = {
  ...
  hero: {
    eyebrow: "Portfolio",
    name: "栗本 健有",
    nameLatin: "Ken'yu Kurimoto",
    role: "ソフトウェアエンジニア / ロボットの社会実装",
    lede: "2019年からソフトバンクで、屋内外を走るサービスロボットの設計・開発と実証実験に携わってきました。最近は機体そのものよりも、ロボットが社会の中で当たり前に働くために何が必要なのかを考えている時間の方が長くなっています。",
    image: "/assets/albion_image_with_logo.png",
    imageCaption: "屋外自律配送ロボット「Albion」— ハードウェア設計から公道自律走行実証まで担当",
  },
  metrics: [
    { value: "2019—", label: "ソフトバンクにて\nロボット研究開発に従事" },
    { value: "07", label: "主要プロジェクト" },
    {
      value: "05",
      label: "国家プロジェクトへの参画\nデジタル庁 / NEDO / 総務省",
    },
    { value: "06", label: "保有資格・認定" },
  ],
  about: [
    "大学院ではロボットの知能化を研究し、卒業後はソフトバンクで研究開発用ロボットの内製開発に携わってきました。3D CADでの筐体設計から、ROSベースのソフトウェア開発、エレベーターや自動ドアとの連携、そして公道での実証実験まで。ロボットが実際に動く現場に立ち会いながら、一台のロボットが社会で働くために何が必要なのかを、手を動かしながら学んできた7年間でした。",
    "その中で強く感じるようになったのは、ロボットが社会に受け入れられるかどうかを決めるのは技術だけではない、ということでした。建物側の設備、事業者の運用、制度やルール、そしてそれを動かす人たちの合意。技術的に動くロボットをつくることと、それが社会の中で当たり前に働き続けることの間には、まだ大きな隔たりがあります。",
    "これからは、その隔たりを埋める側に回ってみたいと考えています。自分の手でつくることからは少し離れることになりますが、つくる人たちの言葉が分かることは、きっと強みになるはずです。ロボットが社会に実装されていく流れそのものを前に進める仕事に、これから取り組んでいきます。",
    "学生時代は英語劇の舞台に立ったり、学園祭の企画をまとめたりしていました。ものをつくることと、人を巻き込んで場を動かすこと。どちらも同じくらい楽しいと感じるたちで、その両方が活きる場所に行きたいと思っています。",
  ],
  focus: [
    {
      index: "01",
      title: "ロボットと社会インフラの接続",
      titleEn: "Robots × Infrastructure",
      body: "ロボットが一台で完結する時代は終わりつつあります。エレベーター、自動ドア、施設の管理システム、そして都市の交通。ロボットがそれらの一部として動くための仕組みづくりに、これまでずっと関わってきました。社会実装が最も詰まるのはこの接点の部分だと感じています。",
    },
    {
      index: "02",
      title: "AIを積んだロボットが現場に出るまで",
      titleEn: "Physical AI in the Field",
      body: "学生時代から深層学習・画像認識に取り組んできたので、その技術が現場で何ができて何ができないのかは、ある程度肌感覚として分かるつもりです。研究室のデモと、毎日誰かが使うサービスとの間にある距離を、どう縮めていくのかに関心があります。",
    },
  ],
  contact: {
  ...
  experience: [
    {
      ...
      period: "2019年4月 〜 現在",
      overview:
        "3D CAD設計から組み立て・ROSベースのソフトウェア開発・社内外システムとのインテグレーションまで一貫して担当する研究開発用ロボットの内製開発を主軸に、新規センサーや生成AIツールの検証とロボットへの搭載推進、社内外からの技術相談対応やPoC開発、国家プロジェクトの実証実験への中核メンバーとしての参画（技術協議・アーキテクチャ設計・報告書作成）に従事。",
      projects: [
        {
          name: "けいはんな地区におけるリソース管理サーバーを用いた複数モビリティの走行実験",
          period: "2025年 〜 2026年",
          summary: "異ベンダー間の経路調停を、リソース管理サーバー経由で実現する。",
        ...
        },
        {
          ...
          period: "2024年 〜 2025年",
          summary: "屋外自律配送ロボットを設計・製作し、公道自律走行実証に投入する。",
          role: "ソフトウェアエンジニア / ハードウェアエンジニア",
          description:
            "屋外配送シナリオを含む実証実験への利用を視野に入れ、屋外並びに施設内屋外エリアを走行する「遠隔操作型小型車」に該当する屋外自律配送ロボット「Albion」を開発。デザイナーから提案された外装3Dモデルを基に、Inventor CADを用いてハードウェアを設計・組み立て、既製品の走行車体をベースにハードウェア全体を構築。ソフトウェア面では、これまでROS1で実施してきた開発を本格的にROS2へ移行し、ドアの自動開閉機構、センサーフュージョン、ロック・LED・各種センサのマイコン制御、その他ロボットのベーシックな機能を実装。また、Nav2とOSSの自己位置推定機能を統合し、配布された3D点群地図を用いた走行実験を実施。同機体を青海エリアにおける公道自律走行実証に投入し、フィールド実証のためのシステム設計から実走行まで一貫して担当。",
          tech: [
            "ROS2 Jazzy",
            "Nav2",
            "RTK-GNSS",
        ...
        },
        {
          ...
          period: "2024年",
          summary: "RFA標準規格に準拠し、施設のエレベーター・自動ドアとロボットを接続する。",
          role: "ソフトウェアエンジニア",
          description:
          ...
          videos: [
            {
              ...
              caption: "「STATION Ai」における自動ドア連携",
            },
            {
              url: "/assets/stai_elv.mp4",
              caption: "「STATION Ai」におけるエレベーター連携",
            },
          ],
          links: [
            {
        ...
        },
        {
          ...
          period: "2023年 〜 2024年",
          summary: "複数ロボットとビルインフラを束ねる分散協調フレームワークを設計する。",
          role: "ソフトウェアエンジニア / アーキテクト",
          description:
          ...
          videos: [
            {
              ...
              caption: "共通仕様に基づく異ベンダーロボット間の経路調停",
            },
            {
              url: "/assets/hic_node_edge_mediation.mp4",
              caption: "共通トポロジカル・グラフ情報に基づくノード専有",
            },
          ],
          links: [
            {
        ...
        },
        {
          ...
          period: "2022年 〜 2023年",
          summary: "3次元空間IDを用いた走行方式を設計し、省庁向けにデモンストレーションする。",
          role: "ソフトウェアエンジニア / ハードウェアエンジニア",
          description:
            "デジタル庁主導の「デジタルツイン構築に関する調査研究」の一環として実施された、3次元空間IDデータを活用したロボット走行実証実験に参画。実証実験向けロボット仕様の策定や空間IDの活用例の提案に携わるとともに、既存の内製ロボットをベースに実証用ロボット機体の設計・開発。空間IDを活用したロボット走行方式を設計し、空間IDに基づくデータベース設計および走行プログラムを実装。また、省庁関係者向けにロボット走行デモンストレーションを実施し、空間IDを活用した新しいロボット制御手法の有効性を実証。このとき、実験の機会を活用して施設のBIMデータを活用した自己位置推定用地図作成を実施。地図作成の効率化の実現と空間ID導出に必要な緯度経度情報の取得に成功。",
          ...
          images: [
            ...
            },
            {
              ...
              caption: "施設のBIMデータから自己位置推定用の2D地図を作成",
            },
          ],
        ...
        },
        {
          ...
          period: "2020年 〜 2021年",
          summary: "日本初、信号機と連携した屋外配送ロボットの走行を実現する。",
          role: "ソフトウェアエンジニア",
          description:
            "NEDOの「自動走行ロボットを活用した新たな配送サービス実現に向けた技術開発事業」（当社実施案件）において、屋外走行対応ROSロボットのソフトウェア開発全般を担当。OSS自動運転ソフトウェアであるAutowareを用いた屋外ナビゲーション機能を構築し、自動走行機能をロボットシステムに統合。特筆すべき取り組みとして、日本信号株式会社が提供する信号情報通信ハードウェアと連携し、信号状態を認識する機能を実装することで、日本初となる信号機と連携した屋外配送ロボットの走行を実現。また、東京ポートシティ竹芝において、屋内外走行を考慮した地図切り替え機能を設計・実装し、複数フロアに対応した配送システムを開発。",
        ...
        },
        {
          ...
          period: "2019年 〜 2020年",
          summary: "複数フロアをまたぐ屋内配送システムをゼロから立ち上げる。",
          role: "ソフトウェアエンジニア",
          description:
            "総務省の「令和元年度 IoTの安心・安全かつ適正な利用環境の構築に係る委託事業」として実施された、自律走行ロボットとエレベーター連携による屋内配送実証において、複数フロアにまたがる移動配送システムのソフトウェア開発全般を担当。複数フロア対応の施設情報管理フォーマットを設計し、複数地図切り替え機能を設計・実装することで、異なるフロア間でのシームレスな移動を実現。自社の研究開発ロボット機体にSMACHベースのアプリを初めて導入し、ベンダー仕様に基づくMQTT通信によるエレベーター連携機能を実装。後続の東京ポートシティ竹芝におけるロボット実証では、ビル設備管理システム「ビルフィーユ（三菱電機株式会社提供）」とのROS連携機能を構築。また、長期に亘る警備巡回運用を想定したGoogleカレンダー連携機能などを設計・実装。",
